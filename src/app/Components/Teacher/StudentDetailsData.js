                ...
                <>
                    <View className="flex-row pb-5 pt-7 border-b-[1px] border-b-gray-300">
                        <View className="items-center flex-1">
                            <Text style={{ fontFamily: 'Poppins_700Bold' }} className="text-xl text-neutral-900">{ attendances.present }</Text>
                            <Text style={{ fontFamily: 'Poppins_400Regular' }} className="text-neutral-900">Aanwezig</Text>
                        </View>
                        <View className="items-center flex-1">
                            <Text style={{ fontFamily: 'Poppins_700Bold' }} className="text-xl text-neutral-900">{ attendances.total - attendances.present }</Text>
                            <Text style={{ fontFamily: 'Poppins_400Regular' }} className="text-neutral-900">Afwezig</Text>
                        </View>
                    </View>
                    <View className="mt-8">
                        <Text style={{ fontFamily: 'Poppins_500Medium' }} className="text-xl text-neutral-900">Aanwezigheden</Text>
                        <View>
